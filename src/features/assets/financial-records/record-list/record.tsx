...
import { RecordListScreen } from '@/features/assets/financial-records/record-list/record-list-screen'
...
import { getAssetsHistoryDetailPageRoutePath, getFastPayAssetsHistoryDetailPageRoutePath } from '@/helper/route'
      ...
      <div>
        {recordList.map((item, index: number) => (
          <div
            ...
            onClick={() =>
              link(
                getFastPayAssetsHistoryDetailPageRoutePath({ id: item.id, page: AssetsHistoryPageTypeEnum.historyList })
              )
            }
          >
