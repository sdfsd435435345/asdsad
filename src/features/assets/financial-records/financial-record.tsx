...
import { RecordScreenModal } from '@/features/assets/financial-records/record-screen-modal'
import { useAssetsStore } from '@/store/assets/spot'
import { Record } from '@/features/assets/financial-records/record-list/record'
import { usePageContext } from '@/hooks/use-page-context'
import { AssetsSelection } from '@/features/assets/financial-records/assets-selection'
...
import { getAssetsHistoryPageRoutePath, getFastPayAssetsHistoryPageRoutePath } from '@/helper/route'
...
export function FinancialRecordLayout() {
  ...
  const handleTabClick = (name: FinancialRecordRouteEnum) => {
    link(getFastPayAssetsHistoryPageRoutePath(setFinancialRecordLogType(name)), { overwriteLastHistoryEntry: true })
  ...
  const onLoadList = async (isRefresh?: boolean) => {
    ...
    let params: AssetsRecordsListReq = {
      ...
      logType: +logType || AssetsRouteEnum.commission,
    }
