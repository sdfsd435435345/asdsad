...
/**
 * 接口 [绑定手机验证↗](https://yapi.nbttfc365.com/project/77/interface/api/6079) 的 **请求类型**
 *
...
/**
 * 接口 [绑定手机验证↗](https://yapi.nbttfc365.com/project/77/interface/api/6079) 的 **返回类型**
 *
 * @分类 [用户中心↗](https://yapi.nbttfc365.com/project/77/interface/api/cat_606)
 * @请求头 `POST /v1/member/safe/mobile/bind`
 * @更新时间 `2023-06-08 16:52:21`
...
// /**
// * [绑定手机验证↗](https://yapi.nbttfc365.com/project/77/interface/api/6079)
// **/
