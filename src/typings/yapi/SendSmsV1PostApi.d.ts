...
/**
 * 接口 [发送短信验证码↗](https://yapi.nbttfc365.com/project/77/interface/api/6024) 的 **请求类型**
 *
...
export interface YapiPostV1SendSmsApiRequest {
  /**
   *     类型1注册，2登录，3.提币 4.已登录修改密码 5.修改邮箱前进行通用验证 6.关闭邮箱前进行通用验证  9修改手机号前进行通用验证 10关闭手机号前进行通用验证 11.修改手机号码 12绑定手机号码 13重置安全项验证 21商户注册
   */
  type: number
  /**
   * 手机号，未登陆必传
...
/**
 * 接口 [发送短信验证码↗](https://yapi.nbttfc365.com/project/77/interface/api/6024) 的 **返回类型**
 *
 * @分类 [用户中心↗](https://yapi.nbttfc365.com/project/77/interface/api/cat_606)
 * @请求头 `POST /v1/send/sms`
 * @更新时间 `2023-06-08 16:52:14`
...
// /**
// * [发送短信验证码↗](https://yapi.nbttfc365.com/project/77/interface/api/6024)
// **/
