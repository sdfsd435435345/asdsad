...
/**
 * 接口 [(后台接口)冻结资金_inner↗](https://yapi.nbttfc365.com/project/77/interface/api/8419) 的 **请求类型**
 *
...
/**
 * 接口 [(后台接口)冻结资金_inner↗](https://yapi.nbttfc365.com/project/77/interface/api/8419) 的 **返回类型**
 *
 * @分类 [资产、充值提现↗](https://yapi.nbttfc365.com/project/77/interface/api/cat_614)
 * @请求头 `POST /inner/v1/balance/lock`
 * @更新时间 `2023-06-08 16:52:40`
...
// /**
// * [(后台接口)冻结资金_inner↗](https://yapi.nbttfc365.com/project/77/interface/api/8419)
// **/
